...
public:
    ...
    CButton m_checkMLSTAR_NL;
    CButton m_checkMLSTARM_NL;
    CButton m_checkMFBMSTAR_NL;
    CButton m_checkMFBMSTARM_NL;
	afx_msg void OnBnClickedMlstarNl();
	afx_msg void OnBnClickedMfbmstarNl();
	afx_msg void OnBnClickedMlstarm();
};
