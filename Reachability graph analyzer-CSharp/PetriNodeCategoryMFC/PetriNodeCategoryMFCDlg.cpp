...
void CPetriNodeCategoryMFCDlg::OnBnClickedAnalyze()
{
    ...
    if (GNoLastPA->CreateGraphFromFile(csFilePath.GetBuffer()))//从文件中读入构建图的数据
    {
        //G->PrintEdgeNode();//打印节点
        GNoLastPA->GetSConnection();//计算强连通分量
